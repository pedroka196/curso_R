...
```{r setup, include=F}
#Aqui será carregado os pacotes necessários para o documentos
library(xtable)
library(forcats)
library(scales)
#Por padrão, ele não colocará o echo, colocará a imagem próxima e não mostrará o aviso (warning)
...
A PDAD 2015 visitou **`r nrow(pdad_domicilios)`** domicílios e coletou informações de `r nrow(pdad_moradores)`. A marcação é similar à marcação em   \LaTeX.
